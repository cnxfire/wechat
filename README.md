...
[![pkg](https://img.shields.io/badge/dev-reference-007d9c?logo=go&logoColor=white&style=flat)](https://pkg.go.dev/github.com/cnxfire/wechat?tab=doc)
...
## 快速开始
```
import "github.com/cnxfire/wechat"
```
